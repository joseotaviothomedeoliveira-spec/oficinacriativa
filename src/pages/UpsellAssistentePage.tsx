...
const HotmartSalesFunnel = () => {
  ...
  useEffect(() => {
    ...
    if (!document.querySelector('script[src="https://checkout.hotmart.com/lib/hotmart-checkout-elements.js"]')) {
      ...
      script.onload = () => {
        try {
          ...
          console.error("Hotmart sales funnel error:", e);
        }
      };
      document.head.appendChild(script);
    } else {
      // Script already loaded, just mount
      try {
        (window as any).checkoutElements?.init("salesFunnel")?.mount("#hotmart-sales-funnel");
      } catch (e) {
        console.error("Hotmart sales funnel error:", e);
  ...
  return <div id="hotmart-sales-funnel" className="mx-auto w-full max-w-md" />;
};
...
const UpsellAssistentePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Oferta Especial — Assistente Pedagógico</title>
        <meta
          name="description"
          ...
          <div className="container mx-auto max-w-2xl px-4">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[hsl(210,65%,50%)] to-[hsl(230,60%,45%)] p-[2px] shadow-xl shadow-[hsl(215,50%,50%)]/15">
              <div className="rounded-3xl bg-gradient-to-br from-[hsl(210,35%,97%)] to-white px-6 py-10 md:px-12">
                ...
                {/* Hotmart Sales Funnel Widget (replaces CTA button) */}
                <div className="mt-10">
                  <HotmartSalesFunnel />
                </div>
              </div>
...
export default UpsellAssistentePage;
